...
def train_lora_fn(foundation_model_path=None, revision=None, input_img_dir=None, output_img_dir=None, work_dir=None):
    bat_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'train_lora.bat')
    
    os.system(f'{bat_file_path} {foundation_model_path} {revision} "film/film" {input_img_dir} {output_img_dir} {work_dir}')
...
def launch_pipeline(uuid,
    ...
    instance_data_dir = os.path.join('D:\\AI\\', uuid, 'training_data', output_model_name)

    lora_model_path = f'D:\\AI\\{uuid}\{output_model_name}'
...
class Trainer:
    ...
    def run(
        ...
        if not os.path.exists(f"D:\\AI\\{uuid}"):
            os.makedirs(f"D:\\AI\\{uuid}")
        work_dir = f"D:\\AI\\{uuid}\\{output_model_name}"
        print("----------work_dir: ", work_dir)

        source_img_dir = f"D:\\AI\\{uuid}\\sources"
